defmodule GlobaltideWeb.JobLive.Index do
  ...
  def mount(params, session, socket) do
    ...
    # Extract unique jobTags from job_data
    job_tags = job_data |> Enum.map(& &1.jobTag) |> Enum.uniq()

    # Create filters based on job_tags
  ...
  def render(assigns) do
    ...
    <.job_listing id="job_listing" job_data={@job_data} />
    """
  end
