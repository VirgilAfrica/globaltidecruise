...
job_data = [
  ...
  %{
    ...
    jobTitle: "Repairman",
    shortDesc: "Take on a critical role in the Deck Department as a Repairman, ensuring the ship's mechanical and operational systems are maintained at top performance.",
    longDesc: [
   ...
   %{
    ...
    shortDesc: "Embark on a maritime career as a Deck Crew Member, where you'll play a crucial role in ship operations and safety. Join a skilled team and contribute to maintaining smooth sailing at sea.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Launch your maritime career as an Assistant Electrician, where you'll support the ship’s electrical systems and ensure safe, efficient operations at sea. Be a vital part of the team that keeps everything running smoothly.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Kickstart your culinary career as a Chef De Partie, where you'll lead a section of the galley team to create exceptional dining experiences for guests and crew alike.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Kickstart your culinary career as a Management Trainee in the Galley, where you will gain valuable hands-on experience in shipboard kitchen operations and contribute to delivering exceptional dining experiences.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Join our culinary team as an Executive Sous Chef, where you'll play a key role in managing kitchen operations, supporting the Executive Chef, and ensuring exceptional dining experiences for our guests.",
    longDesc: [
  ...
  %{
    ...
    jobTag: "Restaurant",
    jobTitle: "Waiter",
    shortDesc: "Join our team as a Waiter and be part of delivering exceptional dining experiences. Play a crucial role in providing outstanding guest service and food presentation at every meal.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Join our team as a Wine Steward and be a key part of delivering exceptional wine service. You’ll provide expert recommendations, ensure proper wine storage, and elevate guest experiences with your knowledge of fine wines.",
    longDesc: [
  ...
  %{
    ...
    jobTag: "Beverages",
    jobTitle: "Bartender",
    shortDesc: "Join our dynamic team as a Bartender, where you’ll be a key player in providing excellent beverage service and crafting memorable experiences for guests at sea.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Step into your shipboard career as a Security Officer, ensuring the safety and security of guests, crew, and the ship itself. Play a key role in maintaining a secure environment onboard.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Join our team as a Guest Service Officer, providing outstanding guest experiences through exceptional service, professionalism, and a welcoming attitude.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Join our team as a Photographer and capture unforgettable moments at sea. Help guests preserve their most cherished memories with your professional photography skills.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Start an exciting career at sea as a Casino Dealer, providing top-notch entertainment and gaming experiences for guests. Join a vibrant team and showcase your skills in a dynamic environment.",
    longDesc: [
  ...
  %{
    ...
    jobTag: "Restaurant",
    jobTitle: "Concierge",
    shortDesc: "Embark on your shipboard career as a Concierge, where you'll provide personalized guest services, ensuring a seamless and exceptional dining and hospitality experience at sea.",
    longDesc: [
  ...
  %{
    ...
    shortDesc: "Join the onboard Activity Staff team and create unforgettable experiences through engaging entertainment, recreational activities, and vibrant events for guests of all ages.",
  ...
  %{
    ...
    shortDesc: "Elevate onboard energy as an Entertainment DJ, where you'll curate unforgettable musical experiences, set the vibe for events, and keep guests dancing all night long.",
  ...
  %{
    ...
    shortDesc: "Take the helm of ship operations as an Engineer Officer, ensuring the smooth functioning of critical machinery and systems while maintaining safety and efficiency at sea.",
  ...
  %{
    ...
    shortDesc: "Set sail as a Human Resource Manager and play a pivotal role in supporting and empowering the ship’s crew while ensuring a positive and efficient work environment.",
  ...
  %{
    ...
    jobTag: "Restaurant",
    jobTitle: "Jr Waiter",
    shortDesc: "Kickstart your hospitality career as a Jr Waiter, providing exceptional dining service to guests onboard while gaining valuable experience in a fast-paced, dynamic environment.",
  ...
  %{
    ...
    shortDesc: "Take the helm as a Lead Navigator, ensuring the ship’s safe passage and leading the navigation team to deliver a seamless and efficient journey at sea.",
  ...
  %{
    ...
    shortDesc: "Step into the role of Events & Guest Service Supervisor, where you'll oversee event execution and guest service operations, ensuring unforgettable experiences at sea.",
  ...
  %{
    ...
    shortDesc: "Step into the role of Executive Chef, where you'll lead a talented culinary team in creating exceptional dining experiences onboard, ensuring world-class cuisine for every guest.",
  ...
  %{
    ...
    shortDesc: "Join the team as a Good Spirits Bartender and craft unforgettable moments by delivering exceptional cocktails, personalized service, and unique beverage experiences at sea.",
  ...
  %{
    ...
    shortDesc: "Take charge of creating lasting memories as a Photo Manager, leading a team to deliver exceptional photography services and onboard experiences for guests.",
